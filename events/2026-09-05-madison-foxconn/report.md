...
To make their point, every saturday Sortition USA runs a simple experiment at Madison's Farmer's market that is designed 
...
in the face of complex challenges that are as wise, if not wiser, as those made in the capitol building. 
...
The important point isn't eloquence or intelligence, or access to secret and privleged information, or being "the right kind of person". 
...
Our process encourages learning across differences thereby allowing robust solutions to be found. The end result is that the *system* moves away from default positions,and find solutions that no one person or party advocates above all others.
...
both ways on the political spectrum. Over time, everyone loses and becomes more and desperate to lock in their positions and 
make changes irreversible, leading to polarization and divided societies. To combat these undesirable social traits, 
democracies around the world are beginning to experiment with participatory solutions a bit like Sorition USA's post-it note system but 
more sophisticated, and they are finding that the solutions discovered with wide-band deliberative input, actually benefits both 
sides of the political spectrum!

This report shows what happened on Saturday 5th September when we presented everyday people at the farmer's market and put them in the hotseat 
...
![The board near the start of the day at 10 am](photos/board-10am.jpg)
*The board at the start of the day (10 am).*

![The board later in the day at 1 pm](photos/board-1pm.jpg)
...
That forces the punter to read *all* the notes that are exposed on the board.  There aren't that many individual piles and it doesn't take long. Its important 
...
![The board editor](editor.png)
*Using AI, we transcribed the results of board into a digital version and input the virtual post it notes into a small tool built for the job, 
...
We only report the top message on each pile. The other message beneath are similar enough that someone thought theirs was the same. 
...
people in a row put their note on that one spot - but note that is it a fragile problem. Its stands alone with little support. Its possible, from this very small amount of evidence, that "Protecting the Environment" is a "blinker" that drives narrow-mindedness in the face of complexity.

The "wall-of-why" is a picture of the problem. We read read it to see what problems people raised
...
happens on the solution side of the board. Its interesting that scored in the same way as solutions "Corruption" is seen as the biggest pain point in the largest group.
...
So perhaps, some related notes were files at opposite ends that could have been put together, 
...
We are here to promote an idea and find people who like it, so that's not necessary bad from our point of view.
...
and possibly even allowing a 2Dimensional scoring system. 

If anyone is interested in learning more about citizens assemblies, civic participation or lotteries as a process 
then please do reach out to the Madison team or Sortition US at: https://sortitionusa.org/ 
